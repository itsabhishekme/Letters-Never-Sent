  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute right-0 top-0 h-64 w-64 rounded-full bg-white/[0.03] blur-3xl opacity-0 transition duration-700 group-hover:opacity-100" />

        <div className="absolute bottom-0 left-0 h-64 w-64 rounded-full bg-white/[0.02] blur-3xl opacity-0 transition duration-700 group-hover:opacity-100" />
